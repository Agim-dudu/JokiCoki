                        ...
                        <div class="row">
                            <div class="col-xl-6 col-lg-7 col-md-12">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay="0.2s">Sealamat Datang<br> Joki Coki</h1>
                                    <p data-animation="fadeInLeft" data-delay="0.4s">Kamu Bingung dan Pusing Dengan Tugas Kuliah Yang Numpuk atau Kamu Mau Daftar Buat Jadi Joki Tugas Buat Penghasilan Tambahan Ayo Daftar di Website Joki Coki</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            ...
                            <div class="features-caption">
                                <h3>60+ Jurusan</h3>
                                <p>Kami menyediakan 60 lebih pilihan prodi yang sesuai dengan tugas kamu.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            ...
                            <div class="features-caption">
                                <h3>Penjoki Berpengalaman</h3>
                                <p>Para penjoki yang kami sediakan terbukti berpengalaman dalam mengerjakan tugas tugas kalian</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-8">
                        <div class="single-services mb-30">
                            ...
                            <div class="features-caption">
                                <h3>Life Chat 24 jam</h3>
                                <p>fitur chat 24 jam yang di sediakan apabila ingin melakukan revisi maupun request kepada Penjoki</p>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="topic-area section-padding40">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-7 col-lg-8">
                        <div class="section-tittle text-center mb-55">
                            <h2>Pilih Sesuai Jurusan Kalian</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                            ...
                            <div class="topic-img">
                                ...
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Pendidikan Komputer</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-topic text-center mb-30">
                            <div class="topic-img">
                                ...
                                <div class="topic-content-box">
                                    <div class="topic-content">
                                        <h3><a href="#">Pendidikan Geografi</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
